...
Third element: "4 and 7 and 5sum to 16."
...
function sumAndMultiply(a, b, c) {
  ...
  let theSumAvg = sum(a,b)[0];
  let firstProccess = sum(theSumAvg,c)[0];
  

  
  let theMultiAvg = multiply(a,b)[0];
  let secondProccess = multiply(theMultiAvg,c)[0];

  return [firstProccess, secondProccess, `${a} and ${b} and ${c} sum to ${firstProccess}.`,`The product of ${a} and ${b} and ${c} is ${secondProccess}.`];
